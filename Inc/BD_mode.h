...
#pragma pack(1)
  struct tagBDConf{
    ...
    float bdVoltage;
    tagSpecState  specState;
    int32_t identTreshold;
    int32_t scaleInstability;
    
    MODBUS::tagRegsType regTypeCPS;
    uint16_t diagCPS;
    MODBUS::tagRegsType regTypeDR;
    uint16_t regStartDR;
...
#pragma pack(1)
  struct tagBDScreeen{
    ...
    uint8_t  colorIntefaceRGB[3];
    uint8_t  colorFontRGB[3];
  };
#pragma pack()
